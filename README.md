...
- 김용현 : 항상 웹 프로젝트와 공부만 해 오다 처음으로 한 앱 프로젝트여서 기억에 오래 남을 것 같다. 그동안 동아리 공식 문서집이나 총정리 글이 쉽게 접할 수 없어 아쉬웠던 점을 해결하고 싶은 마음이 컸는데, 직접 만든 프로그램으로 조금이나마 도움이 될 수 있겠다고 생각해서 더욱 그럴지도 모르겠다. 물론 Firebase 구글 로그인과 동기화 설정은 방학 중임에도 가끔씩 해를 보게 만들기도 했지만 앞으로 새로운 분야에 도전할 때는 지금보다 조금 더 수월해질 것이라고 믿는다:D 특히나 혼자 관련 수업 들었다고 해서 조금은 기대했을지 모르지만 후반부로 갈수록 존재감이 점점 옅어지는 감이 있는 팀원 데리고 완성까지 열심히 해준 팀원들이 최고였다 ._.7
