...
- 김용현 : 이전에 했던 웹과는 달리 첫 앱 프로젝트여서 기억에 오래 남을 것 같다. 평소 한동에 있는 동아리들과 공동체들을 하나로 묶어주는 서비스가 없다는 일종의 갈증을 내가 기획부터 마무리까지 한 프로그램으로 풀 수 있어서 일 것이다. 물론 Firebase와 로그인 부분은 여전히 나를 힘들게 했지만, 만드는 한달여 간의 기간 내내 주변 사람들에게 하나하나 보여주고 좋은 대답을 기대하는 나를 보면서 "아 내가 정말 프로그램을 만들고 싶어하는구나" 라는 생각도 하게 되었다. 비록 방학중에도 가끔씩은 아침 해를 보기도 하고 나는 정말로 아는 게 하나도 없는걸까 하면서 고민도 했었지만, 그걸 훌쩍 뛰어넘는 뿌듯함을 가지고 이런 후기를 쓸 수 있어서 행복하다:D 마지막으로, 유일하게 관련 수업 듣고 뭔가 알려주려나 했지만 마지막에 갈수록 점점 비슷해져가는 나를 데리고 멋지게 프로젝트를 마무리해준 초이스 팀원들이 최고다! 
